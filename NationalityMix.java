...
//        System.out.println(studentInfo);
        ...
        for (int i = 0; i < studentInfo.size(); i += 4) {
            people.add(
                    ...
                    new PeopleClass(studentInfo.get(i), studentInfo.get(i+1), 1)
                    //name, homeroom
...
//        System.out.println(people.get(0).getName());
        ...
        Function<PeopleClass, String> discriminator = PeopleClass::getNationality;
